 ...
 <section class="content">
          ...
          <form class="row" method="post">
              ...
              <div class="form-group col-6">
                  ...
                  <select class="form-control" id="profesor" name="profesor" placeholder="Profesor de Curso">
                  <?= $optionsProfesores ?>  
                </select>
              </div>
              <div class="form-group col-6">
                  <label for="delegado">Delegado del curso</label>
                  <select class="form-control" id="delegado" name="delegado" placeholder="Delegado del Curso">
                  <?= $optionsAlumnos ?>  
                </select>
              </div>
